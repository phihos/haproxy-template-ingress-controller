...
# and git for oscrypto dependency (socat removed as it's not needed in the controller)
RUN apt-get update && apt-get install -y dumb-init libssl3 libssl-dev ca-certificates git && rm -rf /var/lib/apt/lists/*
