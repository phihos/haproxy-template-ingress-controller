...
class GlobalBaseLogSendHostname(BaseModel):
    """
    GlobalBaseLogSendHostname
    """ # noqa: E501
    enabled: StrictStr
    param: Optional[Annotated[str, Field(strict=True)]] = None
    __properties: ClassVar[List[str]] = ["enabled", "param"]
    ...
    def param_validate_regular_expression(cls, value):
