...
@_attrs_define
class CreateStorageSSLCrtListFileBody:
    """
    Attributes:
        file_upload (Union[Unset, File]): The certificate list to upload
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_storage_ssl_crt_list_file_body = cls(
            file_upload=file_upload,
        )

        create_storage_ssl_crt_list_file_body.additional_properties = d
        return create_storage_ssl_crt_list_file_body
