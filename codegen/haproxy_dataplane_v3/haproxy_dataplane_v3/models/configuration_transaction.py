...
from ..models.configuration_transaction_status import ConfigurationTransactionStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="ConfigurationTransaction")
...
class ConfigurationTransaction:
    ...
    Attributes:
        ...
        id (Union[Unset, str]):
        status (Union[Unset, ConfigurationTransactionStatus]):
    """

    field_version: Union[Unset, int] = UNSET
    id: Union[Unset, str] = UNSET
    status: Union[Unset, ConfigurationTransactionStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = ConfigurationTransactionStatus(_status)

        configuration_transaction = cls(
            field_version=field_version,
            id=id,
            status=status,
        )

        configuration_transaction.additional_properties = d
