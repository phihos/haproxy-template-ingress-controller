...
class Acl(BaseModel):
    ...
    """ # noqa: E501
    acl_name: Annotated[str, Field(strict=True)]
    criterion: Annotated[str, Field(strict=True)]
    metadata: Optional[Dict[str, Any]] = None
    value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["acl_name", "criterion", "metadata", "value"]

    @field_validator('acl_name')
    def acl_name_validate_regular_expression(cls, value):
    ...
    def criterion_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^[^\s]+$", value):
            raise ValueError(r"must validate the regular expression /^[^\s]+$/")
        return value
