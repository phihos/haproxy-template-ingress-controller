...
@_attrs_define
class CreateStorageSSLCertificateBody:
    """
    Attributes:
        file_upload (Union[Unset, File]): The SSL certificate to upload
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_storage_ssl_certificate_body = cls(
            file_upload=file_upload,
        )

        create_storage_ssl_certificate_body.additional_properties = d
        return create_storage_ssl_certificate_body
