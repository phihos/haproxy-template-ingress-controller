...
class MailersSection(BaseModel):
    """
    ...
    mailer_entries: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["metadata", "name", "timeout", "mailer_entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mailer_entries": obj.get("mailer_entries")
        })
        return _obj
