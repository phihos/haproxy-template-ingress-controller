...
class SetStickTableEntriesRequest(BaseModel):
    """
    SetStickTableEntriesRequest
    """ # noqa: E501
    data_type: StickTableEntry
    key: StrictStr
    __properties: ClassVar[List[str]] = ["data_type", "key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data_type": StickTableEntry.from_dict(obj["data_type"]) if obj.get("data_type") is not None else None,
            "key": obj.get("key")
        })
        return _obj
