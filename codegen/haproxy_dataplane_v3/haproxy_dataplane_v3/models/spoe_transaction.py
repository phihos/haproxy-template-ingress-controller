...
class SpoeTransaction(BaseModel):
    """
    SPOE configuration transaction
    """ # noqa: E501
    version: Optional[StrictInt] = Field(default=None, alias="_version")
    id: Optional[Annotated[str, Field(strict=True)]] = None
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_version", "id", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['failed', 'in_progress', 'success']):
            raise ValueError("must be one of enum values ('failed', 'in_progress', 'success')")
        return value
