...
class NativeStats(BaseModel):
    """
    HAProxy stats array
    """ # noqa: E501
    error: Optional[StrictStr] = None
    runtime_api: Optional[StrictStr] = Field(default=None, alias="runtimeAPI")
    stats: Optional[List[NativeStat]] = None
    __properties: ClassVar[List[str]] = ["error", "runtimeAPI", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": [NativeStat.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
