...
@_attrs_define
class CreateStorageGeneralFileBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_storage_general_file_body = cls(
            file_upload=file_upload,
        )

        create_storage_general_file_body.additional_properties = d
        return create_storage_general_file_body
