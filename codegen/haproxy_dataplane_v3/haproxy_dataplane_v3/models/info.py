...
class Info(BaseModel):
    ...
    """ # noqa: E501
    api: Optional[InfoApi] = None
    system: Optional[InfoSystem] = None
    __properties: ClassVar[List[str]] = ["api", "system"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api": InfoApi.from_dict(obj["api"]) if obj.get("api") is not None else None,
            "system": InfoSystem.from_dict(obj["system"]) if obj.get("system") is not None else None
        })
        return _obj
