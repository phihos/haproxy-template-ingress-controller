...
@_attrs_define
class CreateCaFileBody:
    """
    Attributes:
        file_upload (File): CA certificate file
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_ca_file_body = cls(
            file_upload=file_upload,
        )

        create_ca_file_body.additional_properties = d
        return create_ca_file_body
