...
class Traces(BaseModel):
    ...
    """ # noqa: E501
    entries: Optional[List[TraceEntry]] = Field(default=None, description="list of entries in a traces section")
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["entries", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [TraceEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
