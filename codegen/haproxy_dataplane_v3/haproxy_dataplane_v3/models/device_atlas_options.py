...
class DeviceAtlasOptions(BaseModel):
    ...
    DeviceAtlasOptions
    """ # noqa: E501
    json_file: Optional[StrictStr] = None
    log_level: Optional[StrictStr] = None
    properties_cookie: Optional[StrictStr] = None
    separator: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["json_file", "log_level", "properties_cookie", "separator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties_cookie": obj.get("properties_cookie"),
