...
class Backend:
    ...
    Attributes:
        ...
        http_check_list (Union[Unset, list['HTTPCheck']]):
        ...
        server_switching_rule_list (Union[Unset, list['ServerSwitchingRule']]): HAProxy backend server switching rules
            array (corresponds to use-server directives)
        server_templates (Union[Unset, Any]):
        servers (Union[Unset, Any]):
        stick_rule_list (Union[Unset, list['StickRule']]): HAProxy backend stick rules array (corresponds to stick
            store-request, stick match, stick on, stick store-response)
        tcp_check_rule_list (Union[Unset, list['TCPCheck']]):
        ...
        tcp_response_rule_list (Union[Unset, list['TCPResponseRule']]): HAProxy TCP response rules array (corresponds to
            tcp-response directive)
    """
    ...
    server_templates: Union[Unset, Any] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        http_check_list: Union[Unset, list[dict[str, Any]]] = UNSET
        if not isinstance(self.http_check_list, Unset):
            http_check_list = []
            for componentsschemashttp_checks_item_data in self.http_check_list:
        ...
        server_switching_rule_list: Union[Unset, list[dict[str, Any]]] = UNSET
        if not isinstance(self.server_switching_rule_list, Unset):
            server_switching_rule_list = []
            for componentsschemasserver_switching_rules_item_data in self.server_switching_rule_list:
                componentsschemasserver_switching_rules_item = (
                    componentsschemasserver_switching_rules_item_data.to_dict()
                )
                server_switching_rule_list.append(componentsschemasserver_switching_rules_item)

        server_templates = self.server_templates

        servers = self.servers

        stick_rule_list: Union[Unset, list[dict[str, Any]]] = UNSET
        if not isinstance(self.stick_rule_list, Unset):
            stick_rule_list = []
            for componentsschemasstick_rules_item_data in self.stick_rule_list:
        ...
        tcp_check_rule_list: Union[Unset, list[dict[str, Any]]] = UNSET
        if not isinstance(self.tcp_check_rule_list, Unset):
            tcp_check_rule_list = []
            for componentsschemastcp_checks_item_data in self.tcp_check_rule_list:
        ...
        tcp_response_rule_list: Union[Unset, list[dict[str, Any]]] = UNSET
        if not isinstance(self.tcp_response_rule_list, Unset):
            tcp_response_rule_list = []
            for componentsschemastcp_response_rules_item_data in self.tcp_response_rule_list:
        ...
        if http_check_list is not UNSET:
            field_dict["http_check_list"] = http_check_list
        ...
        if server_switching_rule_list is not UNSET:
            field_dict["server_switching_rule_list"] = server_switching_rule_list
        if server_templates is not UNSET:
            field_dict["server_templates"] = server_templates
        if servers is not UNSET:
            field_dict["servers"] = servers
        if stick_rule_list is not UNSET:
            field_dict["stick_rule_list"] = stick_rule_list
        if tcp_check_rule_list is not UNSET:
            field_dict["tcp_check_rule_list"] = tcp_check_rule_list
        if tcp_request_rule_list is not UNSET:
            field_dict["tcp_request_rule_list"] = tcp_request_rule_list
        if tcp_response_rule_list is not UNSET:
            field_dict["tcp_response_rule_list"] = tcp_response_rule_list
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backend = cls(
            ...
            http_check_list=http_check_list,
            ...
            server_switching_rule_list=server_switching_rule_list,
            server_templates=server_templates,
            servers=servers,
            stick_rule_list=stick_rule_list,
            tcp_check_rule_list=tcp_check_rule_list,
            tcp_request_rule_list=tcp_request_rule_list,
            tcp_response_rule_list=tcp_response_rule_list,
        )
