...
class SslCrlEntryRevokedCertificatesInner(BaseModel):
    """
    SslCrlEntryRevokedCertificatesInner
    """ # noqa: E501
    revocation_date: Optional[date] = None
    serial_number: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["revocation_date", "serial_number"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "revocation_date": obj.get("revocation_date"),
