...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for componentsschemasssl_crt_list_files_item_data in _response_200:
            componentsschemasssl_crt_list_files_item = SSLCRTListFile.from_dict(
                componentsschemasssl_crt_list_files_item_data
            )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, list["SSLCRTListFile"]]]:
    return Response(
