...
def sync_detailed(
    ...
    *,
    ...
    Args:
        parent_name (str):
        name (str):
        body (RuntimeServer): Runtime transient server properties Example: {'address':
            '127.0.0.5', 'admin_state': 'ready', 'operational_state': 'up', 'port': 80, 'server_id':
            1, 'server_name': 'web_server'}.
