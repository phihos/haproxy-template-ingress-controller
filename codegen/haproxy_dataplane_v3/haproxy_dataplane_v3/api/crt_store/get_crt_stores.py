...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/services/haproxy/configuration/crt_stores",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        response_200 = []
        for componentsschemascrt_stores_item_data in _response_200:
            componentsschemascrt_stores_item = CertificateStore.from_dict(componentsschemascrt_stores_item_data)
