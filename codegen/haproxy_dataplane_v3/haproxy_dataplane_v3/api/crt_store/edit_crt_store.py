...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/crt_stores/{name}",
        "params": params,
    }
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CertificateStore, Error]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CertificateStore): Storage mechanism to load and store certificates used in the
            configuration
