...
def _get_kwargs() -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/services/haproxy/runtime/ssl_crt_lists",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for componentsschemasssl_crt_lists_item_data in _response_200:
            componentsschemasssl_crt_lists_item = SSLCrtList.from_dict(componentsschemasssl_crt_lists_item_data)
