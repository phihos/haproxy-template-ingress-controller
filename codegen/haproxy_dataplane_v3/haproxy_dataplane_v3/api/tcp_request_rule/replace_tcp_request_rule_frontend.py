...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/frontends/{parent_name}/tcp_request_rules/{index}",
        "params": params,
    }
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, TCPRequestRule]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (TCPRequestRule): HAProxy TCP Request Rule configuration (corresponds to tcp-request)
            Example: {'cond': 'if', 'cond_test': '{ src 192.168.0.0/16 }', 'index': 0, 'type':
            'connection'}.
