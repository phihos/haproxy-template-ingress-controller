...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/frontends/{parent_name}/tcp_request_rules",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        response_200 = []
        for componentsschemastcp_request_rules_item_data in _response_200:
    ...
    if response.status_code == 202:
        ...
        response_202 = []
        for componentsschemastcp_request_rules_item_data in _response_202:
            componentsschemastcp_request_rules_item = TCPRequestRule.from_dict(
                componentsschemastcp_request_rules_item_data
            )
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (list['TCPRequestRule']): HAProxy TCP request rules array (corresponds to tcp-request
            directive)
