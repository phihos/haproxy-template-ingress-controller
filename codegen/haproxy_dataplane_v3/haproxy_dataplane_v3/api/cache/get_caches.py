...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/services/haproxy/configuration/caches",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        response_200 = []
        for componentsschemascaches_item_data in _response_200:
            componentsschemascaches_item = Cache.from_dict(componentsschemascaches_item_data)
