...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/frontends/{parent_name}/http_request_rules",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for componentsschemashttp_request_rules_item_data in _response_200:
    ...
    if response.status_code == 202:
        ...
        for componentsschemashttp_request_rules_item_data in _response_202:
            componentsschemashttp_request_rules_item = HTTPRequestRule.from_dict(
                componentsschemashttp_request_rules_item_data
            )
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (list['HTTPRequestRule']): HAProxy HTTP request rules array (corresponds to http-
            request directives)
