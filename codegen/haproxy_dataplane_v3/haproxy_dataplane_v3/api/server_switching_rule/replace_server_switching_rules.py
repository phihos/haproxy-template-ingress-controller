...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/backends/{parent_name}/server_switching_rules",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        response_200 = []
        for componentsschemasserver_switching_rules_item_data in _response_200:
    ...
    if response.status_code == 202:
        ...
        response_202 = []
        for componentsschemasserver_switching_rules_item_data in _response_202:
            componentsschemasserver_switching_rules_item = ServerSwitchingRule.from_dict(
                componentsschemasserver_switching_rules_item_data
            )
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (list['ServerSwitchingRule']): HAProxy backend server switching rules array
            (corresponds to use-server directives)
