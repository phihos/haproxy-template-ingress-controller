...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/services/haproxy/configuration/backends/{parent_name}/server_switching_rules/{index}",
        "params": params,
    }
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, ServerSwitchingRule]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ServerSwitchingRule): HAProxy server switching rule configuration (corresponds to
            use-server directive) Example: {'cond': 'if', 'cond_test': '{ req_ssl_sni -i
            www.example.com }', 'target_server': 'www'}.
