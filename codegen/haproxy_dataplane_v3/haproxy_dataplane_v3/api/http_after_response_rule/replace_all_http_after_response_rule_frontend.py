...
def _get_kwargs(
    parent_name: str,
    *,
    body: list["HTTPAfterResponseRule"],
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/frontends/{parent_name}/http_after_response_rules",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for componentsschemashttp_after_response_rules_item_data in _response_200:
    ...
    if response.status_code == 202:
        ...
        for componentsschemashttp_after_response_rules_item_data in _response_202:
            componentsschemashttp_after_response_rules_item = HTTPAfterResponseRule.from_dict(
                componentsschemashttp_after_response_rules_item_data
            )
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (list['HTTPAfterResponseRule']): HAProxy HTTP after response rules array (corresponds
            to http-after-response directives)
