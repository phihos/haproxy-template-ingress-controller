...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/frontends/{parent_name}/http_after_response_rules/{index}",
        "params": params,
    }
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, HTTPAfterResponseRule]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (HTTPAfterResponseRule): HAProxy HTTP after response rule configuration (corresponds
            to http-after-response directives) Example: {'cond': 'unless', 'cond_test': '{ src
            192.168.0.0/16 }', 'hdr_format': 'max-age=31536000', 'hdr_name': 'Strict-Transport-
            Security', 'type': 'set-header'}.
