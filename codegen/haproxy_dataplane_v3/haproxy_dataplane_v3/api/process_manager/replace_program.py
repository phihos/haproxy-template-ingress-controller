...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/programs/{name}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (Program): HAProxy program configuration Example: {'command': 'spoa-mirror --runtime
            0 --mirror-url http://test.local', 'group': 'mygroupname', 'name': 'mirror', 'start-on-
            reload': 'enabled', 'user': 'myusername'}.
