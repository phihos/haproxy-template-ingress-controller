...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/spoe/spoe_files/{parent_name}/scopes/{scope_name}/groups/{name}",
        "params": params,
    }
...
) -> Response[Union[Error, SPOEGroup]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (SPOEGroup): SPOE group section configuration
