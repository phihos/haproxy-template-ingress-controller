...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/http_errors_sections/{name}",
        "params": params,
    }
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, HttpErrorsSection]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (HttpErrorsSection): A globally declared group of HTTP errors Example:
            {'error_files': [{'code': 400, 'name': '/etc/haproxy/errorfiles/site1/400.http'}, {'code':
            404, 'name': '/etc/haproxy/errorfiles/site1/404.http'}], 'name': 'website-1'}.
