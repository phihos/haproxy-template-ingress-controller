...
def _get_kwargs(
    parent_name: str,
    *,
    body: list["BackendSwitchingRule"],
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/frontends/{parent_name}/backend_switching_rules",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for componentsschemasbackend_switching_rules_item_data in _response_200:
    ...
    if response.status_code == 202:
        ...
        for componentsschemasbackend_switching_rules_item_data in _response_202:
            componentsschemasbackend_switching_rules_item = BackendSwitchingRule.from_dict(
                componentsschemasbackend_switching_rules_item_data
            )
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (list['BackendSwitchingRule']): HAProxy backend switching rules array (corresponds to
            use_backend directives)
