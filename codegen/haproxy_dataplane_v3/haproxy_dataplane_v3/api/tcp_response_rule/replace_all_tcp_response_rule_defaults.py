...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/defaults/{parent_name}/tcp_response_rules",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (list['TCPResponseRule']): HAProxy TCP response rules array (corresponds to tcp-
            response directive)
