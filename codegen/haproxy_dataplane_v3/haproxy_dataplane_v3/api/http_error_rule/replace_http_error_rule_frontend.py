...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/frontends/{parent_name}/http_error_rules/{index}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (HTTPErrorRule): HAProxy HTTP error rule configuration (corresponds to http-error
            directives) Example: {'index': 0, 'status': 425, 'type': 'status'}.
