...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/frontends/{parent_name}/filters/{index}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (Filter): HAProxy filters Example: {'trace_name': 'name', 'trace_rnd_parsing': True,
            'type': 'trace'}.
