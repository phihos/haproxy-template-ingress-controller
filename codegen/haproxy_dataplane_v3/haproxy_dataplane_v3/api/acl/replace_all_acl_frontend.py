...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/services/haproxy/configuration/frontends/{parent_name}/acls",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 202:
        ...
        for componentsschemasacls_item_data in _response_202:
            componentsschemasacls_item = ACLLines.from_dict(componentsschemasacls_item_data)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (list['ACLLines']): HAProxy ACL lines array (corresponds to acl directives)
