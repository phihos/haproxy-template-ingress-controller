...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/services/haproxy/configuration/frontends/{parent_name}/acls/{index}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ACLLines): The use of Access Control Lists (ACL) provides a flexible solution to
            perform
