...
json = "{}"
# create an instance of DefaultServer from a JSON string
default_server_instance = DefaultServer.from_json(json)
# print the JSON string representation of the object
print(DefaultServer.to_json())

# convert the object into a dict
default_server_dict = default_server_instance.to_dict()
# create an instance of DefaultServer from a dict
default_server_from_dict = DefaultServer.from_dict(default_server_dict)
```
