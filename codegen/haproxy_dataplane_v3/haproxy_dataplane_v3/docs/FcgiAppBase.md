...
json = "{}"
# create an instance of FcgiAppBase from a JSON string
fcgi_app_base_instance = FcgiAppBase.from_json(json)
# print the JSON string representation of the object
print(FcgiAppBase.to_json())

# convert the object into a dict
fcgi_app_base_dict = fcgi_app_base_instance.to_dict()
# create an instance of FcgiAppBase from a dict
fcgi_app_base_from_dict = FcgiAppBase.from_dict(fcgi_app_base_dict)
```
