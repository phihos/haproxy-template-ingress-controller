...
# **create_user**
> User create_user(userlist, data, transaction_id=transaction_id, version=version, force_reload=force_reload)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    api_instance = haproxy_dataplane_v3.UserApi(api_client)
    userlist = 'userlist_example' # str | Parent userlist name
    data = haproxy_dataplane_v3.User() # User | 
    ...
    try:
        # Add a new userlist user
        api_response = await api_instance.create_user(userlist, data, transaction_id=transaction_id, version=version, force_reload=force_reload)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a user
        await api_instance.delete_user(username, userlist, transaction_id=transaction_id, version=version, force_reload=force_reload)
    except Exception as e:
...
# **get_user**
> User get_user(username, userlist, transaction_id=transaction_id)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Return one userlist user
        api_response = await api_instance.get_user(username, userlist, transaction_id=transaction_id)
...
# **get_users**
> List[User] get_users(userlist, transaction_id=transaction_id)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Return an array of userlist users
        api_response = await api_instance.get_users(userlist, transaction_id=transaction_id)
...
# **replace_user**
> User replace_user(username, userlist, data, transaction_id=transaction_id, version=version, force_reload=force_reload)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Replace a user
        api_response = await api_instance.replace_user(username, userlist, data, transaction_id=transaction_id, version=version, force_reload=force_reload)
