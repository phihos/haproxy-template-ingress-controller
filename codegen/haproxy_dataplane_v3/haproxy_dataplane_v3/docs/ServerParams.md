...
json = "{}"
# create an instance of ServerParams from a JSON string
server_params_instance = ServerParams.from_json(json)
# print the JSON string representation of the object
print(ServerParams.to_json())

# convert the object into a dict
server_params_dict = server_params_instance.to_dict()
# create an instance of ServerParams from a dict
server_params_from_dict = ServerParams.from_dict(server_params_dict)
```
