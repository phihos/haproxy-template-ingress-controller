# haproxy_dataplane_v3.SpecificationApi
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    api_instance = haproxy_dataplane_v3.SpecificationApi(api_client)

    try:
        # Data Plane API Specification
        api_response = await api_instance.get_specification()
        print("The response of SpecificationApi->get_specification:\n")
        pprint(api_response)
