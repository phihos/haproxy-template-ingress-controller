...
json = "{}"
# create an instance of Bind from a JSON string
bind_instance = Bind.from_json(json)
# print the JSON string representation of the object
print(Bind.to_json())

# convert the object into a dict
bind_dict = bind_instance.to_dict()
# create an instance of Bind from a dict
bind_from_dict = Bind.from_dict(bind_dict)
```
