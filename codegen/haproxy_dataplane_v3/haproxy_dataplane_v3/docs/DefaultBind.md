...
json = "{}"
# create an instance of DefaultBind from a JSON string
default_bind_instance = DefaultBind.from_json(json)
# print the JSON string representation of the object
print(DefaultBind.to_json())

# convert the object into a dict
default_bind_dict = default_bind_instance.to_dict()
# create an instance of DefaultBind from a dict
default_bind_from_dict = DefaultBind.from_dict(default_bind_dict)
```
