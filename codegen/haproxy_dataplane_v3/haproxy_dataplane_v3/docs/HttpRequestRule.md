...
http_request_rule_instance = HttpRequestRule.from_json(json)
# print the JSON string representation of the object
print(HttpRequestRule.to_json())

# convert the object into a dict
http_request_rule_dict = http_request_rule_instance.to_dict()
# create an instance of HttpRequestRule from a dict
http_request_rule_from_dict = HttpRequestRule.from_dict(http_request_rule_dict)
```
