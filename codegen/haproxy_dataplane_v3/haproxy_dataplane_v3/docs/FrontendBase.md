...
frontend_base_instance = FrontendBase.from_json(json)
# print the JSON string representation of the object
print(FrontendBase.to_json())

# convert the object into a dict
frontend_base_dict = frontend_base_instance.to_dict()
# create an instance of FrontendBase from a dict
frontend_base_from_dict = FrontendBase.from_dict(frontend_base_dict)
```
