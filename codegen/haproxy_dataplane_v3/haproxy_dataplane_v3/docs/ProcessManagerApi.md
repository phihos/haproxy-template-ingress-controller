# haproxy_dataplane_v3.ProcessManagerApi
...
# **create_program**
> Program create_program(data, transaction_id=transaction_id, version=version, force_reload=force_reload)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    api_instance = haproxy_dataplane_v3.ProcessManagerApi(api_client)
    data = haproxy_dataplane_v3.Program() # Program | 
    ...
    try:
        # Add a program
        api_response = await api_instance.create_program(data, transaction_id=transaction_id, version=version, force_reload=force_reload)
        print("The response of ProcessManagerApi->create_program:\n")
        pprint(api_response)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a program
        await api_instance.delete_program(name, transaction_id=transaction_id, version=version, force_reload=force_reload)
    except Exception as e:
...
# **get_program**
> Program get_program(name, transaction_id=transaction_id)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Return a program
        api_response = await api_instance.get_program(name, transaction_id=transaction_id)
        print("The response of ProcessManagerApi->get_program:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_programs**
> List[Program] get_programs(transaction_id=transaction_id)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Return an array of programs
        api_response = await api_instance.get_programs(transaction_id=transaction_id)
        print("The response of ProcessManagerApi->get_programs:\n")
        pprint(api_response)
    except Exception as e:
...
# **replace_program**
> Program replace_program(name, data, transaction_id=transaction_id, version=version, force_reload=force_reload)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Replace a program
        api_response = await api_instance.replace_program(name, data, transaction_id=transaction_id, version=version, force_reload=force_reload)
        print("The response of ProcessManagerApi->replace_program:\n")
        pprint(api_response)
    except Exception as e:
