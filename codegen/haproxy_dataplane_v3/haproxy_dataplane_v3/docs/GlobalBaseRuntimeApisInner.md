...
json = "{}"
# create an instance of GlobalBaseRuntimeApisInner from a JSON string
global_base_runtime_apis_inner_instance = GlobalBaseRuntimeApisInner.from_json(json)
# print the JSON string representation of the object
print(GlobalBaseRuntimeApisInner.to_json())

# convert the object into a dict
global_base_runtime_apis_inner_dict = global_base_runtime_apis_inner_instance.to_dict()
# create an instance of GlobalBaseRuntimeApisInner from a dict
global_base_runtime_apis_inner_from_dict = GlobalBaseRuntimeApisInner.from_dict(global_base_runtime_apis_inner_dict)
```
