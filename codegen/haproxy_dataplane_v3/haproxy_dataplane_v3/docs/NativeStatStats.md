...
**last_agt** | **str** |  | [optional] 
**last_chk** | **str** |  | [optional] 
...
native_stat_stats_instance = NativeStatStats.from_json(json)
# print the JSON string representation of the object
print(NativeStatStats.to_json())

# convert the object into a dict
native_stat_stats_dict = native_stat_stats_instance.to_dict()
# create an instance of NativeStatStats from a dict
native_stat_stats_from_dict = NativeStatStats.from_dict(native_stat_stats_dict)
```
