...
process_info_item_instance = ProcessInfoItem.from_json(json)
# print the JSON string representation of the object
print(ProcessInfoItem.to_json())

# convert the object into a dict
process_info_item_dict = process_info_item_instance.to_dict()
# create an instance of ProcessInfoItem from a dict
process_info_item_from_dict = ProcessInfoItem.from_dict(process_info_item_dict)
```
