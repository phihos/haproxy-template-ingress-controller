...
# **create_peer**
> PeerSection create_peer(data, transaction_id=transaction_id, version=version, force_reload=force_reload, full_section=full_section)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    api_instance = haproxy_dataplane_v3.PeerApi(api_client)
    data = haproxy_dataplane_v3.PeerSection() # PeerSection | 
    ...
    try:
        # Add a peer
        api_response = await api_instance.create_peer(data, transaction_id=transaction_id, version=version, force_reload=force_reload, full_section=full_section)
        print("The response of PeerApi->create_peer:\n")
        pprint(api_response)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a peer
        await api_instance.delete_peer(name, transaction_id=transaction_id, version=version, force_reload=force_reload)
    except Exception as e:
...
# **get_peer_section**
> PeerSection get_peer_section(name, transaction_id=transaction_id, full_section=full_section)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Return a peer
        api_response = await api_instance.get_peer_section(name, transaction_id=transaction_id, full_section=full_section)
        print("The response of PeerApi->get_peer_section:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_peer_sections**
> List[PeerSection] get_peer_sections(transaction_id=transaction_id, full_section=full_section)
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    try:
        # Return an array of peer_section
        api_response = await api_instance.get_peer_sections(transaction_id=transaction_id, full_section=full_section)
        print("The response of PeerApi->get_peer_sections:\n")
        pprint(api_response)
    except Exception as e:
...
[**List[PeerSection]**](PeerSection.md)
