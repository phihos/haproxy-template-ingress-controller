...
json = "{}"
# create an instance of GlobalBase from a JSON string
global_base_instance = GlobalBase.from_json(json)
# print the JSON string representation of the object
print(GlobalBase.to_json())

# convert the object into a dict
global_base_dict = global_base_instance.to_dict()
# create an instance of GlobalBase from a dict
global_base_from_dict = GlobalBase.from_dict(global_base_dict)
```
