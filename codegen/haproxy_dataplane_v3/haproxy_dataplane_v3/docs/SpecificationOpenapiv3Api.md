# haproxy_dataplane_v3.SpecificationOpenapiv3Api
...
async with haproxy_dataplane_v3.ApiClient(configuration) as api_client:
    ...
    api_instance = haproxy_dataplane_v3.SpecificationOpenapiv3Api(api_client)

    try:
        # Data Plane API v3 Specification
        api_response = await api_instance.get_openapiv3_specification()
        print("The response of SpecificationOpenapiv3Api->get_openapiv3_specification:\n")
        pprint(api_response)
