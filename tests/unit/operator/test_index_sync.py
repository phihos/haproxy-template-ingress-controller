...
class TestIndexSynchronizationTracker:
    """Test the IndexSynchronizationTracker class."""

    def test_init_proper_resource_tracking(self, config):
    ...
    def test_mark_ready_triggers_completion(self, tracker):
    ...
    def test_mark_ready_ignores_unknown_types(self, tracker):
    ...
    def test_mark_ready_disabled_after_completion(self, tracker):
    ...
    @pytest.mark.asyncio
    async def test_wait_for_indices_ready_immediate_return(self, tracker):
    ...
    @pytest.mark.asyncio
    async def test_wait_for_indices_ready_with_marks(self, tracker):
    ...
    @pytest.mark.asyncio
    async def test_wait_for_indices_ready_with_timeout(self):
    ...
    def test_haproxy_pods_always_tracked(self):
    ...
    def test_haproxy_pods_with_watched_resources(self, tracker):
