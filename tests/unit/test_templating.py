...
def test_b64decode_filter_success():
...
def test_b64decode_filter_empty_string():
    """Test b64decode filter with empty string."""
    result = b64decode_filter("")
    assert result == ""


def test_b64decode_filter_unicode():
...
def test_snippet_loader_init_with_snippets(sample_snippets):
...
def test_snippet_loader_get_source_string_snippet():
...
def test_get_template_environment_without_snippets():
...
def test_get_template_environment_b64decode_filter():
...
def test_template_environment_factory_create_environment_without_snippets():
    """Test creating environment without snippets."""
...
def test_template_environment_factory_create_environment_with_config():
...
def test_template_environment_factory_create_environment_error_handling():
...
def test_template_environment_factory_create_environment_filters_available():
...
def test_template_environment_factory_create_environment_with_problematic_config():
...
def test_template_compiler_init_with_snippets(template_compiler_sample_snippets):
    """Test TemplateCompiler initialization with snippets."""
    compiler = TemplateCompiler(template_compiler_sample_snippets)
    assert isinstance(compiler.environment, Environment)


def test_template_compiler_init_without_snippets():
    """Test TemplateCompiler initialization without snippets."""
    compiler = TemplateCompiler()
    assert isinstance(compiler.environment, Environment)


def test_template_compiler_compile_template_success(template_compiler_sample_snippets):
...
def test_template_compiler_compile_template_with_snippet(
    template_compiler_sample_snippets,
):
...
def test_template_compiler_compile_template_syntax_error():
...
# TestCompileTemplateFunction tests
def test_compile_template_function_no_snippets():
...
def test_compile_template_function_with_snippets_tuple():
...
def test_compile_template_function_caching():
...
def test_compile_template_function_syntax_error():
    """Test template compilation with syntax error."""
    with pytest.raises(ValueError, match="Template syntax error"):
        compile_template("{{ invalid syntax")


# TestRenderTemplateFunction tests
def test_render_template_function_simple():
...
def test_render_template_function_with_snippets():
...
def test_render_template_function_error():
...
def test_template_renderer_init_with_snippets(template_renderer_sample_snippets):
    """Test TemplateRenderer initialization with snippets."""
    renderer = TemplateRenderer(template_renderer_sample_snippets)
    assert isinstance(renderer._compiler, TemplateCompiler)
    assert renderer._compiled_templates == {}


def test_template_renderer_init_without_snippets():
...
def test_template_renderer_render_success(template_renderer_sample_snippets):
...
def test_template_renderer_render_caching():
...
def test_template_renderer_render_error():
    """Test template rendering with error."""
    renderer = TemplateRenderer()
    template_str = "{{ undefined_var.missing_attr }}"
...
def test_template_renderer_get_compiled_success():
...
def test_template_renderer_get_compiled_caching():
...
def test_template_renderer_get_compiled_error():
...
def test_template_renderer_clear_cache():
...
def test_template_renderer_cache_size_property():
...
def test_template_renderer_validate_template_success():
...
def test_template_renderer_validate_template_syntax_error():
...
def test_template_renderer_validate_template_not_found(
    template_renderer_sample_snippets,
):
...
def test_template_renderer_validate_template_general_error():
...
# TestValidateConfigTemplates tests
def test_validate_config_templates_empty_config():
...
def test_validate_config_templates_valid_snippets():
...
def test_validate_config_templates_invalid_snippet():
...
def test_validate_config_templates_string_snippets():
...
def test_validate_config_templates_valid_maps():
...
def test_validate_config_templates_invalid_map():
...
def test_validate_config_templates_valid_haproxy_config():
...
def test_validate_config_templates_invalid_haproxy_config():
...
def test_validate_config_templates_valid_certificates():
...
def test_validate_config_templates_invalid_certificate():
...
def test_validate_config_templates_comprehensive():
...
def test_validate_config_templates_edge_cases():
...
# TestGetPathFilterSecurity tests
def test_get_path_filter_valid_filenames():
    ...
    assert (
        get_path_filter("error404.http", "file") == "/etc/haproxy/general/error404.http"
    )


def test_get_path_filter_path_traversal_protection():
...
def test_get_path_filter_directory_names_blocked():
...
def test_get_path_filter_null_byte_injection():
...
def test_get_path_filter_path_separators_blocked():
...
def test_get_path_filter_empty_invalid_filenames():
...
def test_get_path_filter_invalid_content_types():
...
def test_get_path_filter_with_custom_config():
    ...
    assert (
        get_path_filter("tls.pem", "certificate", mock_config) == "/custom/ssl/tls.pem"
    )
    assert get_path_filter("500.http", "file", mock_config) == "/custom/files/500.http"


def test_get_path_filter_path_traversal_with_normalization():
...
def test_get_path_filter_comprehensive_attack_scenarios():
...
def test_get_path_filter_case_sensitivity():
...
def test_get_path_filter_boundary_conditions():
...
def test_get_path_filter_url_encoded_attacks():
...
def test_get_path_filter_unicode_normalization_attacks():
...
def test_get_path_filter_comprehensive_encoded_attacks():
...
def test_get_path_filter_whitelist_validation():
...
# TestFormatTemplateError tests
def test_format_template_error_simple():
...
def test_format_template_error_with_line_number():
...
def test_format_template_error_deeply_nested_includes():
    ...
    result = format_template_error(error, "main_template", template_content, snippets)

    assert "Template 'main_template' rendering failed" in result
    assert "Error in deeply nested snippet" in result


def test_format_template_error_missing_snippet():
...
def test_format_template_error_syntax_errors():
...
def test_format_template_error_nonetype_hint():
...
def test_format_template_error_undefined_hint():
...
def test_format_template_error_filter_hint():
...
def test_format_template_error_attribute_hint():
...
def test_format_template_error_two_level_include():
...
def test_format_template_error_empty_template():
...
def test_format_template_error_invalid_line_numbers():
...
def test_format_template_error_long_error_messages():
...
# TestExtractSnippetName tests
def test_extract_snippet_name_single_quotes():
...
def test_extract_snippet_name_double_quotes():
...
def test_extract_snippet_name_with_spaces():
...
def test_extract_snippet_name_no_include():
...
def test_extract_snippet_name_malformed():
...
def test_extract_snippet_name_partial():
...
# TestGetContextLines tests
def test_get_context_lines_basic():
...
def test_get_context_lines_at_start():
...
def test_get_context_lines_at_end():
...
def test_get_context_lines_empty_list():
    """Test with empty lines list."""
    result = _get_context_lines([], 0, 1)
    assert result == []


def test_get_context_lines_invalid_index():
...
def test_get_context_lines_formatting():
